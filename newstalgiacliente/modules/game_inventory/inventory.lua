...
local function combatEvent()
    inventoryController.ui.onPanel.stop:setChecked(not g_game.isSafeFight())
    inventoryController.ui.offPanel.stop:setChecked(not g_game.isSafeFight())
...
function inventoryController:onInit()
    ...
    connect(inventoryController.ui.onPanel.stop, {
        onCheckChange = onSetSafeFight
    })
    connect(inventoryController.ui.offPanel.stop, {
        onCheckChange = onSetSafeFight
    })
end
...
function inventoryController:onGameStart()
    ...
    for i, elementGroup in ipairs(elements) do
        local show = (i == 1 and showBlessings)
...
function onSetSafeFight(self, checked)
    inventoryController.ui.onPanel.stop:setChecked(checked)
    inventoryController.ui.offPanel.stop:setChecked(checked)
