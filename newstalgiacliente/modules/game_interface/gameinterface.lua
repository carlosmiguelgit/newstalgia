...
-- by consumers to pause automation while the player walks;
...
local function isPremiumPlayer()
    ...
    return player ~= nil and player:isPremium()
end
...
function createThingMenu(menuPosition, lookThing, useThing, creatureThing)
    ...
    if useThing then
        ...
        if useThing:isLyingCorpse() and g_game.getFeature(GameThingQuickLoot) and modules.game_quickloot and useThing:getPosition().x ~= 0xffff and isPremiumPlayer() then
    ...
    if g_game.getFeature(GameThingQuickLoot) and modules.game_quickloot and isPremiumPlayer() and lookThing and not lookThing:isCreature() and lookThing:isPickupable() then
            ...
            elseif useThing then
                ...
                if useThing:isContainer() or useThing:isLyingCorpse() then
                    ...
                    elseif useThing:isPickupable() then
                        ...
                        g_game.open(useThing)
                        return true
                    elseif g_game.getFeature(GameThingQuickLoot) and modules.game_quickloot and isPremiumPlayer() then
                ...
                elseif useThing then
                    ...
                    if useThing:isContainer() or useThing:isLyingCorpse() then
                        ...
                        elseif table.find({ 3497, 3498, 3499, 3500, 3502, 12902 }, useThing:getId()) then
                            ...
                            g_game.open(useThing)
                            return true
                        elseif g_game.getFeature(GameThingQuickLoot) and modules.game_quickloot and isPremiumPlayer() and modules.client_options.getOption('lootOnRightClick') then
        ...
        elseif lootControlMode == 1 then
            ...
            if mouseButton == MouseRightButton and keyboardModifiers == KeyboardShiftModifier then
                if useThing and (useThing:isContainer() or useThing:isLyingCorpse()) then
                    if g_game.getFeature(GameThingQuickLoot) and modules.game_quickloot and isPremiumPlayer() then
                        g_game.sendQuickLoot(1, useThing)
                        return true
                    else
                        g_game.open(useThing)
