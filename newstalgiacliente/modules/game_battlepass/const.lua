-- Battle Pass network protocol and shared constants.
-- Protocol: client -> server byte 0x36 (free on C->S), server -> client byte 0x39
-- (0x37 is used natively by the shader system in this client).
...
BattlePassSelectableRewardTypes = {
