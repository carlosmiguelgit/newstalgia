-- codigo da ia opencode -s ses_fef675924ffe70zsv7Fk77PyqS
...
Services = {
    ...
    websites = "https://127.0.0.1", --./client_entergame "Forgot password and/or email"
...
if ENABLE_SERVERS then
    ...
    Servers_init = {
        ...
        -- Login server
        ---
        -- Configuration for the login server (HTTPS only).
        -- @class table
        -- @name login_server
        -- @field port Port used for HTTPS connection
